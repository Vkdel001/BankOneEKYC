...
import MCLandingPage from './components/MCLandingPage'; // ✅ add this line
...
function App() {
  const [currentScreen, setCurrentScreen] = useState<Screen>('auth'); // ✅ Start from login screen
...
const handleBackToApprovalMatrixFromEntityTaxResidency = () => {
  ...
  return (
    <AuthWrapper>
      ...
      {currentScreen === 'landing' && (
        <LandingPage onApplyOnline={handleApplyOnline} />
      )}
  ...
  <MCLandingPage onApplyOnline={handleApplyOnline} />
      ...
      {currentScreen === 'approval-matrix' && (
        <ApprovalMatrixForm onBack={handleBackToInternetBanking} 
